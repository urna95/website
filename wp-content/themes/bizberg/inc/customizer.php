...
function bizberg_kirki_fields(){
	...
	*/
	...
	require_once trailingslashit( get_template_directory() ) . '/inc/customizer/navigation/sticky-menu.php';
	...
	*/
	...
	Kirki::add_section( 'sticky_menu_options', array(
	    'title'          => esc_html__( 'Sticky Menu', 'bizberg' ),
	    'panel'          => 'navigation',
	    'capability'     => 'edit_theme_options',
	    'priority' => 20
	) );
