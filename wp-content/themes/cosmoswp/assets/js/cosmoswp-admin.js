...
jQuery( document ).ready(
	function($){
		...
		/*banner selection*/
		$( '#cosmoswp_banner_options_layout' ).change(
			function() {
		...
		$( '#cosmoswp_custom_banner_layout_options' ).change(
			function(){
				var selected_val         = $( this ).find( ":selected" ).val(),
