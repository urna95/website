( function( $ ) {
	...
	global_partial_refresh_dynamic_css.forEach(
		function(item) {
			wp.customize(
				item,
				function( value ) {
	...
	global_partial_refresh_dynamic_typography.forEach(
		function(item) {
			wp.customize(
				item,
				function( value ) {
	...
	header_partial_refresh_dynamic_css.forEach(
		function(item) {
			wp.customize(
				item,
				function( value ) {
	...
	header_partial_refresh_dynamic_typography.forEach(
		function(item) {
			wp.customize(
				item,
				function( value ) {
	...
	* */
	...
	header_partial_refresh_header_general.forEach(
		function(item) {
			wp.customize(
				item,
				function( value ) {
	...
	*/
	...
	footer_partial_refresh_dynamic_css.forEach(
		function(item) {
			wp.customize(
				item,
				function( value ) {
	...
	footer_partial_refresh_dynamic_typography.forEach(
		function(item) {
			wp.customize(
				item,
				function( value ) {
	...
	sticky_footer_partial_refresh_dynamic_css.forEach(
		function(item) {
			wp.customize(
				item,
				function( value ) {
	...
	sticky_footer_partial_refresh_dynamic_typography.forEach(
		function(item) {
			wp.customize(
				item,
				function( value ) {
	...
	blog_content_partial_refresh_dynamic_css.forEach(
		function(item) {
			wp.customize(
				item,
				function( value ) {
	...
	blog_partial_refresh_dynamic_typography.forEach(
		function(item) {
			wp.customize(
				item,
				function( value ) {
	...
	post_content_partial_refresh_dynamic_css.forEach(
		function(item) {
			wp.customize(
				item,
				function( value ) {
	...
	let page_content_partial_refresh_dynamic_css = [
		...
		page_content_partial_refresh_dynamic_css.forEach(
			function(item) {
				wp.customize(
					item,
					function( value ) {
	...
	banner_partial_refresh_dynamic_css.forEach(
		function(item) {
			wp.customize(
				item,
				function( value ) {
	...
	main_content_partial_refresh_dynamic_css.forEach(
		function(item) {
			wp.customize(
				item,
				function( value ) {
