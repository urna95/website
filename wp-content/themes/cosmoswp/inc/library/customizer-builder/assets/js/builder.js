(function( $, wp_customize ) {
	...
	var CustomizeBuilder = function( options, id ){
		...
		drag_drop: function(){
			...
			$( '.cosmoswp-device-panel', that.container ).each(
				function(){
					var panel             = $( this );
					var device            = panel.data( 'device' );
					var sortable_ids      = [];
					that.panels[ device ] = {};
					$( '.cosmoswp-cb-items', panel ).each(
						function( index ){
			...
			init: function( controlId, items, devices ){
				...
				that.container.on(
					...
					function(e){
						...
						$( '.cosmoswp-cb-body' ).find( '.cosmoswp-available-items' ).each(
							function () {
	...
	wp_customize.bind(
		...
		function( e, b ) {
			_.each(
				CosmosWP_Customizer_Builder.builders,
				function( opts, id ){
	...
	$document.on(
		'mouseover',
		'.cosmoswp-cb-row .grid-stack-item',
		function( e ) {
			var item  = $( this );
